## ----setup and load all the required libraries, include=FALSE---------------------------------------------------------------
...
## ----Create a subest of the data set including only the clinical variables--------------------------------------------------
rawBC <- rawBC[,1:31]
BC <- rawBC


## ----update missing values set as "" to na----------------------------------------------------------------------------------
BC <- BC %>%
   mutate(across(where(is.character), ~na_if(., "")))


## ----Data Cleaning - turning variables into factor levels where required----------------------------------------------------
...
## ----create summary table of amount of missing data-------------------------------------------------------------------------
...
## ----Re-level some of the factor variables so they are neater---------------------------------------------------------------
...
## ----Create a summary table of the data set, include = FALSE----------------------------------------------------------------
#create new data set
BCNamed <- BC
...
## ----Output the created summary table---------------------------------------------------------------------------------------
...
## ----Histogram of length of survival in months------------------------------------------------------------------------------
...
## ----Bar plot of Patient outcome at the end of the study--------------------------------------------------------------------
...
## ----Cross table of Oncotree code and Breast cancer detailed----------------------------------------------------------------
#create cross table
...
## ----remove the OncoTree Code variable from the data set--------------------------------------------------------------------
BC <- BC[,!(names(BC) %in% c("oncotree_code"))]


## ----Boxplot of patient survival length when primary tumour laterality is missing or not, fig.height=6, fig.width= 6--------
...
## ----Perform a Littles test of MCAr to the data set-------------------------------------------------------------------------
...
## ----Perform Littles test again to see when the null hypothesis is not rejected---------------------------------------------
#subset the data set
...
## ----Understanding the impact of missing data in patient outcome------------------------------------------------------------
...
## ----Perform the random forest imputation on the vairables with missing values, eval=FALSE----------------------------------
...
## ----Read in the Imputted data set and clean it-----------------------------------------------------------------------------
...
## ----Bar plot of tumour stage before and after imputation-------------------------------------------------------------------
...
## ----Histogram of mutation count before and after imputation, fig.width=8---------------------------------------------------
...
## ----Remove the imputed variables and replace the original values with these------------------------------------------------
...
## ----Create the first survival object---------------------------------------------------------------------------------------
...
## ----Kaplan Meier Plot for the entire data set------------------------------------------------------------------------------
...
## ----Kaplan Meier Plot Stratifying by ER status and PR status, fig.width=8--------------------------------------------------
...
## ----Calculate metric for ER status-----------------------------------------------------------------------------------------
...
## ----Calculate metric for PR status-----------------------------------------------------------------------------------------
#calculate median survival time
...
## ----Kaplan Meier Plot Stratifying by HER2 status---------------------------------------------------------------------------
#create Kaplan Meier plot
...
## ----Kaplan Meier Plot Stratifying by whether the patient had chemotherapy--------------------------------------------------
#create Kaplan Meier plot
...
## ----Cox Proportional Hazards using backward variable selection-------------------------------------------------------------
...
## ----Print results from backwards variable selection , fig.height=7, fig.width=8--------------------------------------------
...
## ----Perform Regularised Cox Regression - Set up----------------------------------------------------------------------------
...
## ----Present output of the Regularised Cox PH-------------------------------------------------------------------------------
...
## ----Table of results must be hard coded - using the chunk above------------------------------------------------------------
...
## ----Combining the variable selection approaches,  fig.width = 7, fig.height= 6---------------------------------------------
#create the model
...
## ----Now include interation terms in the model, fig.width = 7, fig.height= 6------------------------------------------------
...
## ----Print the results of ANOVA test----------------------------------------------------------------------------------------
...
## ----Testing the Proportional Hazards assumption for M_int------------------------------------------------------------------
...
## ----Adding startification to the Cox proportional hazards model , fig.width = 7, fig.height= 6-----------------------------
...
## ----Check the PH assumption again after stratification---------------------------------------------------------------------
...
## ----Create AFT models - First the Weibull AFT------------------------------------------------------------------------------
...
## ----Create summary table of different AFT models and AIC values------------------------------------------------------------
...
## ----Create plot of each AFT model against the Kaplan Meier Curve, fig.height=4, fig.width=5--------------------------------
...
## ----Create decision tree from recursive partitioning, fig.width = 16, fig.height= 7----------------------------------------
